...
def generate_launch_description():
    ...
    #args for rviz
    package_description_arg = DeclareLaunchArgument('package_description', default_value="my_components")
    rviz_config_file_name_arg = DeclareLaunchArgument('rviz_config_file_name', default_value='config2.rviz')
    #params for rviz
